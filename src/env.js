...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_TURNKEY_SERVER_SIGN_URL: process.env.NEXT_PUBLIC_TURNKEY_SERVER_SIGN_URL,
    ...
    NEXT_PUBLIC_TURNKEY_RP_ID: process.env.NEXT_PUBLIC_TURNKEY_RP_ID,
