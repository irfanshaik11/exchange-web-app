...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_WALLET_TRACKER_WS_URL:
      process.env.NEXT_PUBLIC_WALLET_TRACKER_WS_URL,
    NEXT_PUBLIC_SOLANA_RPC: process.env.NEXT_PUBLIC_SOLANA_RPC,
    NEXT_PUBLIC_REQUIRE_REFERRAL_ACCESS:
      process.env.NEXT_PUBLIC_REQUIRE_REFERRAL_ACCESS,
    NEXT_PUBLIC_REFERRAL_GATE_HIDDEN:
      process.env.NEXT_PUBLIC_REFERRAL_GATE_HIDDEN,
    NEXT_PUBLIC_DEFAULT_REFERRAL_CODE:
      process.env.NEXT_PUBLIC_DEFAULT_REFERRAL_CODE,
