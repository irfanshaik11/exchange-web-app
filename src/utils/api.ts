    ...
    if (!res.ok) {
      ...
      if (data && typeof data === 'object') {
        ...
        const EXPECTED_ERROR_CODES = [
          ...
          'AMOUNT_TOO_SMALL', 'POOL_UNAVAILABLE', 'TX_FAILED', 'POOL_GRADUATED', 'METEORA_NO_LIQUIDITY', 'NO_LIQUIDITY', 'PUMPAMM_SELL_FAILED', 'BONKSWAP_TRADE_FAILED', 'INVALID_POOL_TYPE', 'TURNKEY_NOT_SUPPORTED', 'TOKEN_NOT_SUPPORTED',
