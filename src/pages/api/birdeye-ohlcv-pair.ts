...
/**
 * Birdeye OHLCV Proxy - Pair endpoint
 * This proxies requests to Birdeye's pair OHLCV endpoint
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const url = `https://public-api.birdeye.so/defi/v3/ohlcv/pair?address=${encodeURIComponent(
    address
