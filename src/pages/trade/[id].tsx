...
export default function TradePage() {
  ...
  const enhancedDisplayToken = React.useMemo(() => {
    ...
    return {
      ...
      dev_held_percentage: holderSummary?.dev_held_percent,
      sniper_held_percentage: holderSummary?.sniper_held_percent,
      sniper_count: holderSummary?.sniper_count,
      bundler_held_percentage: holderSummary?.bundler_held_percent,
        ...
        <div className="fixed inset-0 z-[100] md:hidden">
          ...
          <div ref={modalDragRef}
            ...
            <div className="flex justify-end pr-4 pb-2">
              <button onClick={closeModal} className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ backgroundColor: AX.border, color: AX.textMuted }}>
