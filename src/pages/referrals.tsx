                ...
                <div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {/* While the HTTP request is in flight, the optimistic
                            update has already zeroed pendingSolRewards, so the
                            button label should reflect the on-chain-confirmation
                            phase (~5–30 s) rather than implying the claim is
                            still being initiated. */}
                        {claimRewardsMutation.isPending ? 'Confirming…' : 'Claim'}
                      </button>
                    </div>
                    {/* Minimum claim info */}
