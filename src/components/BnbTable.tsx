  ...
  return (
    <>
      <div className="relative flex h-20 w-20 items-center justify-center">
        ...
        <div
          className="relative rounded-sm border-none p-0 transition-all duration-300 ease-out"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          {/* Single colored border container (moved inward) */}
          <div
            className="relative rounded-sm bg-[#06070b] p-[3px]"
            style={{
              border: `1px solid ${(() => {
        ...
        >
          ...
          >
            <FaCamera size={16} className="text-black drop-shadow-lg" />
          </div>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0">
                ...
                <div
                  className="absolute top-0 left-0 h-0.5 w-full opacity-80"
                  style={{
                ...
                ></div>
                <div
                  className="absolute top-0 left-0 h-full w-0.5 opacity-80"
                  style={{
                ...
                ></div>
                <div
                  className="absolute top-0 right-0 h-full w-0.5 opacity-80"
                  style={{
              ...
              {/* Corner accents */}
              <div
                className="absolute top-1 left-1 h-3 w-3 opacity-90"
                style={{
                  background: `linear-gradient(45deg, ${AX.aiCyan}, ${AX.aiGreen})`,
                  clipPath: "polygon(0 0, 100% 0, 0 100%)",
                }}
              ></div>
              <div
                className="absolute right-1 bottom-1 h-3 w-3 opacity-90"
                style={{
                  background: `linear-gradient(45deg, ${AX.aiBlue}, ${AX.aiCyan})`,
                  clipPath: "polygon(100% 0, 100% 100%, 0 100%)",
                }}
...
function BnbTable({
    ...
    async (protocols: string[]) => {
      ...
      try {
        ...
        const response = await fetch(
          `${endpoint}?limit=50&protocols=${encodeURIComponent(protocolsParam)}&t=${Date.now()}`,
        );
        if (response.ok) {
  ...
  const {
    ...
    onPriceUpdate: useCallback((updates: any[]) => {
      console.log(
        "[PulseTable] 📊 Price update received, merging",
        updates.length,
        "updates",
      );
  ...
  const protocols = [
    ...
    // { name: 'Dynamic BC', icon: <Image src="https://cdn.prod.website-files.com/626692727bba3f384e008e8a/67a5dca8b3ee5d0703f70040_icon-primary.webp" alt="Dynamic BC" width={16} height={16} className="rounded-full" />, color: '#f97316' },
    {
      name: "Raydium",
      icon: (
        <div className="flex h-4 w-4 items-center justify-center rounded-full bg-gray-500 text-xs font-bold text-white">
          R
        </div>
      ),
      color: "#6b7280",
  ...
  const quoteTokens = [
    {
      name: "SOL",
      icon: (
        <div className="flex h-4 w-4 items-center justify-center rounded-full bg-green-500 text-xs font-bold text-white">
          S
        </div>
      ),
      color: "#00ff88",
  ...
  */
      ...
      if (
        ...
        if (aIsHighBondingMeteora && bIsHighBondingMeteora) {
          ...
          const getTimestamp = (token: any): number => {
            ...
            if (!ts) return 0;
            if (typeof ts === "number")
              return ts > 1e12 ? ts : ts > 1e9 ? ts * 1000 : 0;
            if (typeof ts === "string") {
              const n = Number(ts);
  ...
  return (
    <div
      className={`num mb-10 flex w-full flex-1 flex-col shadow-lg lg:min-w-[340px] ${
        isFirstOrLast === "first"
      ...
      style={{
        ...
        borderColor: title.toLowerCase().includes("new")
          ? "rgba(36, 37, 44, 0.015)"
          : AX.border,
        borderStyle: "solid",
        borderWidth: "1px",
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className="hidden items-center justify-center gap-2 rounded-full border px-3 py-1.5 sm:flex"
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-1">
              {["P1", "P2", "P3"].map((pill) => (
                ...
                >
                  <button
                    className={`flex cursor-pointer items-center justify-center px-1.5 py-0.5 text-xs font-medium transition-all duration-200 ${
                      selectedPill === pill
                        ? "text-green-400"
                          ...
                          <div className="space-y-1.5 p-2">
                            ...
                            <div className="flex items-center gap-1.5">
                              <FaGasPump
                                ...
                                style={{ color: "#FCD34D", strokeWidth: "1" }}
                              />
          ...
          <div className="filter-dropdown relative">
            ...
            >
              ...
              {filters.protocols.filter((p: string) => p !== "All").length >
                0 && (
                <span
                  className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-emerald-500 text-xs font-bold text-white"
                  style={{ fontSize: "10px" }}
                >
                  {filters.protocols.filter((p: string) => p !== "All").length}
                </span>
            ...
            .map((token, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {waveTokens.has(idx) && (
                    <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden rounded-lg">
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, transparent, rgba(34, 197, 94, 0.2), rgba(34, 197, 94, 0.4), rgba(34, 197, 94, 0.2), transparent)",
                  ...
                  <div className="relative flex flex-shrink-0 flex-col items-center pt-1">
                    <TokenImage
                      token={token}
                        ...
                        >
                          ...
                          <div className="relative flex items-center gap-1 lg:gap-2">
                            ...
                            {token.mint.slice(-4) === "pump" && (
                              ...
                              >
                                <LuPill size={10} className="lg:h-3 lg:w-3" />
                              </Link>
                            )}
                            ...
                            >
                              <FaSearch size={10} className="lg:h-3 lg:w-3" />
                            </button>
        ...
        >
            ...
            <div className="mt-3 flex gap-2">
              {["0.01", "0.1", "1", "10"].map((amount) => (
                <button
                  ...
                  className="rounded border border-neutral-700 bg-neutral-800 px-3 py-1 text-sm text-white transition-colors hover:bg-neutral-700"
                >
                  {amount}
                </button>
              ))}
              <button className="rounded border border-neutral-700 bg-neutral-800 px-3 py-1 text-sm text-white transition-colors hover:bg-neutral-700">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
          ...
          <div className="mx-4 mb-4">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-bold text-black transition-colors hover:bg-emerald-600"
            >
          ...
          <div className="mx-4 mb-4">
            ...
            <input
              ...
              className="w-full rounded-lg border border-neutral-700 bg-neutral-800 px-3 py-2 text-xs text-white focus:ring-2 focus:ring-emerald-500 focus:outline-none"
              readOnly
            />
          </div>
        </InterstatePopout>
