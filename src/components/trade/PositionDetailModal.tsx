    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-4">
          <div className="bg-[#101114] border border-[#1E1F26] rounded-lg p-4 grid grid-cols-2 gap-x-6 gap-y-4">
            <div>
        ...
        <div className="px-4 pb-6">
          {loadingTrades ? (
            <div className="bg-[#101114] rounded-lg border border-[#1E1F26] p-8 text-center">
