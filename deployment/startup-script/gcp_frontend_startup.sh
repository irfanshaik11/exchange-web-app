...
mkdir -p /home/kishore/logs
chown kishore:kishore /home/kishore/logs

sudo -u kishore bash <<'EOF'

########################################
# Configuration
########################################
PROJECT_DIR="/home/kishore/exchange-web-app"
BRANCH="prod"
APP_NAME="nextjs-app"
ENV_FILE="$PROJECT_DIR/.env"
LOG_DIR="/home/kishore/logs"
